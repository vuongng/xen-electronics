...
server.get('/api/products', function (request, reply) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        server.pg.connect(onConnect);
        onConnect = function (error, client, release) {
            if (err)
...
server.get('/api/product/:id', function (req, reply) { return __awaiter(void 0, void 0, void 0, function () {
    var client, product;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                client = _a.sent();
                return [4 /*yield*/, client.query('SELECT * FROM products WHERE id=$1', [req.params.id])];
            case 2:
